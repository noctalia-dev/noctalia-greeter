...
| `[appearance].clock_time_format` / `.clock_date_format` | Optional `strftime` labels above the login card; empty or omitted hides each label. Updated once per minute. |
